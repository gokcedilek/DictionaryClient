...
public class CSdict {
	...
	// Example code to read command line input and extract arguments.
	    ...
	    System.out.println("The command is: " + command);  // Note: this is not to be printed in the final implementation
	    len = arguments.length;
	    System.out.println("The arguments are: ");  // Note: this is not to be printed in the final implementation    
	    for (int i = 0; i < len; i++) {
		System.out.println("    " + arguments[i]); // Note: this is not to be printed in the final implementation    
	    }
